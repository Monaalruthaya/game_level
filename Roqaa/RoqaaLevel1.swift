...
class RoqaaLevel1: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // حركة الشخصية
        let move1 = SKAction.move(to: CGPoint(x: -400, y:  200), duration: 5)
        let move2 = SKAction.move(to: CGPoint(x: 320, y:  200), duration: 5)
        let move3 = SKAction.move(to: CGPoint(x: -240, y:  60), duration: 5)
        let move4 = SKAction.move(to: CGPoint(x: 240, y:  60), duration: 5)
        let move5 = SKAction.move(to: CGPoint(x: -240, y:  60), duration: 5)
        let move6 = SKAction.move(to: CGPoint(x: 240, y:  -160), duration: 5)
        let move7 = SKAction.move(to: CGPoint(x: -240, y:  -180), duration: 5)
